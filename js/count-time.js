...
function updateCountdown() {
  // calculate remaining time and update countdownElement text content
  var remainingTime = getRemainingTime();
  countdownElement.textContent = "Time remaining: " + remainingTime;
}

function getRemainingTime() {
  // calculate remaining time and return as a string
  return "1 day, 2 hours, 30 minutes";
}
